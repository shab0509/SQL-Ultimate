...
these functions empower us to extract deeper insights from our data – and accomplish 
...
4. FIRST_VALUE() and LAST_VALUE() for extracting boundary values.
  ...
  1. Types of Window Functions
    ...
    Value Functions
        ...
        FIRST_VALUE(): Gets the first value in a window.
        LAST_VALUE(): Gets the last value in a window.
        NTH_VALUE() : Gets the Nth value in a window
...
🔹 Common Types of Window Functions I’ve worked on:
...
Value-related       LEAD()                Accesses value of next row
                    ...
                    Nth Value             Gets the Nth value in the window  
